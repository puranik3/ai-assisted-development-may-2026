...
describe('VoteButtons Component', () => {
  ...
  it('applies custom className to buttons when provided', () => {
    ...
    const buttons = container.querySelectorAll('.custom-btn');
    expect(buttons.length).toBe(2);
  });

  it('applies custom className to count when provided', () => {
    const { container } = render(
      <VoteButtons
        count={5}
        onUpvote={vi.fn()}
